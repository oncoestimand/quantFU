...
author: "Kaspar Rufibach, on behalf of the follow-up quantification taks force of the oncology estimand WG"
...
Code for the paper @rufibach_23fu ([download from journal](https://doi.org/10.1002/pst.2300), [download from arxiv](https://arxiv.org/abs/2206.05216)) written by the [follow-up quantification task force](https://oncoestimand.github.io/oncowg_webpage/docs/taskforces.html#quantification-of-follow-up) of the [oncology estimand WG](http://www.oncoestimand.org).

# Purpose of this document

This R markdown file provides easy accessible code to compute all the quantifiers for follow-up. The github repository where this document is hosted is available [here](https://github.com/oncoestimand/quantFU).
